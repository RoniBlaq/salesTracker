    ...
    formData.append('expertise', expertise);
     formData.append('bio', bio);
      formData.append('availability', availability);
       ...
       if (mentorId) {
        axios.put(`http://localhost/nextphp/mentor.php /${mentorId}`, formData, {
            headers: {
...
<form onSubmit={handleSubmit}>
    ...
    <div className="mb-4">
     ...
     <input type="text" value={expertise} onChange={(e) => setExpertise (e.target.value)} className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" />
     </div>
     <div className="mb-4">
