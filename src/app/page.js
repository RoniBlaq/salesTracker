         ...
         <main className="py-12 px-6 flex flex-col items-center justify-center flex-grow z-10 relative">
          <section className="text-center"> 
            ...
            <div className="flex space-x-4"> 
              <Link href="/first" className="bg-orange-500 hover:bg-orange-700 text-white font-bold py-2 px-4 rounded-full">Add Product</Link>
            <Link href="/SalesTracker" className="bg-orange-500 hover:bg-orange-700 text-white font-bold py-2 px-4 rounded-full">View Sales Tracker</Link>
            {/* transition-colors text-1xl md:text-2xl */}
            </div>
          </section> 
          </main>
